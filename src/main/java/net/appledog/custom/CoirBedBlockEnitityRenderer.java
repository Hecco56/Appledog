...
public class CoirBedBlockEnitityRenderer implements BlockEntityRenderer<CoirBedBlockEntity> {
    ...
    public CoirBedBlockEnitityRenderer(BlockEntityRendererFactory.Context ctx) {
    ...
    public void render(CoirBedBlockEntity bedBlockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
        SpriteIdentifier spriteIdentifier = new SpriteIdentifier(TexturedRenderLayers.BEDS_ATLAS_TEXTURE, Identifier.of(Appledog.MOD_ID, "entity/bed/coir_bed"));
